...
class GeneticAlgorithm(object):
    ...
    def __init__(self, image, piece_size, population_size, generations, elite_size=2):
        ...
        pieces, rows, columns = image_helpers.flatten_image(image, piece_size,1, indexed=True)
...
#	    fp.append(fittest.fitness)
            self.fp.append(fittest.fitness)
            ...
            if verbose:
                plot.show_fittest(fittest.to_image(), "Present Generation: {} ".format(generation + 1))
